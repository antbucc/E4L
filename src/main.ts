...
async function postDataToAPI(action: string, body: object): Promise<ApiResponse> {
    try {
        // Make the POST request using the Fetch API
        const response = await fetch('https://polyglot-api-staging.polyglot-edu.com/api/execution/' + action, {
            method: 'POST',
            headers: {
